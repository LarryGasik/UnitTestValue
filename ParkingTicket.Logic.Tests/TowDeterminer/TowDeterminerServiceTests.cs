...
public class TowDeterminerServiceTests
{
    ...
    public void ShouldReturnValuesFromEnforcementRules()
    {
        ...
        //Act
        var result = _sut.ShouldTowCar(ParkingOffense.BlockingSidewalk, _tag, It.IsAny<int>());
    ...
    {
        //Arrange
        var sampleTicket = new ParkingTicketDto
        {
        ...
        //Assert
        _EnforcementRules.Verify(
            x => x.ShouldTowCar(new List<ParkingTicketDto> { sampleTicket }, ParkingOffense.BlockingSidewalk,
